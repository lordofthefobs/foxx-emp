...
define("EW_REPORT_CONN_HOST", "localhost", TRUE);
define("EW_REPORT_CONN_PORT", 3306, TRUE);
define("EW_REPORT_CONN_USER", "foxx", TRUE);
define("EW_REPORT_CONN_PASS", "cw3651", TRUE);
define("EW_REPORT_CONN_DB", "foxx_emp", TRUE);
...
define("EW_REPORT_RANDOM_KEY", 'ESwk9o55G&9BR8Rf', TRUE); // Random key for encryption
...
define("EW_REPORT_PROJECT_NAME", "Foxx", TRUE); // Project Name
define("EW_REPORT_PROJECT_VAR", "Foxx", TRUE); // Project Name
